...
router.post('/save-item', ProjectItemController.saveItem);
router.get('/search-item-all', ProjectItemController.getItems);
router.get('/search-item/:id', ProjectItemController.getItem);
...
router.put('/add-cart/:id/:name', ProjectItemController.addCart);
router.put('/delete-cart/:id/:name', ProjectItemController.deleteCart);
router.get('/get-cart/:name', ProjectItemController.getCart);
